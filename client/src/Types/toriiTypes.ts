type GameAccount = {owner: BigInt;username: string;energy: number;pvpEnergy: number;crystals: number;gems: number;lastEnergyUpdateTimestamp: number;lastPvpEnergyUpdateTimestamp: number;runesCount: number;heroesCount: number; summonChests: number; lastBattleId: number}
