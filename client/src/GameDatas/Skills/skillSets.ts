const skillSets = {
  ...
  "rex": ["Attack Rex", "Chum Challenge", "Anchor Stomps"],
  "celeste": ["Attack Celeste", "Ice Shatter", "Snow Storm"],
  "oakheart": ["Attack Oakheart", "Lignum Hammer", "Buloke Wall"],
  "sylvara": ["Attack Sylvara", "Silvan Chant", "Astral Beam"],
