...
export async function setupWorld(provider: DojoProvider) {
    ...
    function Game() {
        ...
        const createAccount = async (props: { account: Account, username: string }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
    ...
    function Settings() {
        ...
        // Call the `initSettings` system with the specified Account and calldata
        const initSettings = async (props: { account: Account }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
