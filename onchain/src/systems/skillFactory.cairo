        ...
        fn initSkills(world: IWorldDispatcher) {
            set!(
                ...
                (
                    ...
                    SkillInfos { name: 'Chum Challenge', cooldown: 4, damage: damage::new(0, false, true, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 2 },
        ...
        fn initSkillsBuffs(world: IWorldDispatcher) {
            set!(
                ...
                (
                    ...
                    SkillBuff { skillName: 'Chum Challenge', index: 1, buff: buff::new(BuffType::AttackUp, 60, 3, false, false, true) },
                    ...
                    SkillBuff { skillName: 'Blazing Rage', index: 0, buff: buff::new(BuffType::DefenseUp, 60, 3, false, false, true) },
                    SkillBuff { skillName: 'Blazing Rage', index: 1, buff: buff::new(BuffType::AttackUp, 60, 3, false, false, true) },
