        ...
        fn initSkills(world: IWorldDispatcher) {
            set!(
                ...
                (
                    ...
                    SkillInfos { name: 'Water Heal', cooldown: 3, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(8, false, true, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 1 },
                    ...
                    SkillInfos { name: 'Arrows Rain', cooldown: 4, damage: damage::new(100, false, true, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Enemy, accuracy: 1, buffsCount: 1 },
                    SkillInfos { name: 'Forest Senses', cooldown: 4, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 2 },
                    ...
                    SkillInfos { name: 'Nature Call', cooldown: 4, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 1 },
                    ...
                    SkillInfos { name: 'Chum Challenge', cooldown: 4, damage: damage::new(0, false, true, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 1 },
                    ...
                    SkillInfos { name: 'Lignum Hammer', cooldown: 2, damage: damage::new(180, true, false, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Enemy, accuracy: 1, buffsCount: 1 },
                    ...
                    SkillInfos { name: 'Silvan Chant', cooldown: 3, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(12, false, true, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 1 },
                    ...
                    SkillInfos { name: 'Attack Ember', cooldown: 0, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(10, true, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 0 },
                    ...
                    SkillInfos { name: 'Blazing Rage', cooldown: 4, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 2 },
                    ...
                    SkillInfos { name: 'Swords Dance', cooldown: 4, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 1 },
                    ...
                    SkillInfos { name: 'Ankh Blessing', cooldown: 4, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(0, false, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 1 },
                    SkillInfos { name: 'Khonsu Blessing', cooldown: 3, damage: damage::new(0, false, false, false, damage::DamageType::Flat), heal: skill::heal::new(10, true, false, false, heal::HealType::Percent), targetType: TargetType::Ally, accuracy: 1, buffsCount: 1 },
        ...
        fn initSkillsBuffs(world: IWorldDispatcher) {
            set!(
                ...
                (
                    ...
                    SkillBuff { skillName: 'Water Heal', index: 0, buff: buff::new(BuffType::Regen, 6, 2, false, true, false) },
                    SkillBuff { skillName: 'Water Shield', index: 0, buff: buff::new(BuffType::DefenseUp, 70, 3, true, false, true) },
                    SkillBuff { skillName: 'Arrows Rain', index: 0, buff: buff::new(BuffType::DefenseDown, 30, 2, false, true, false) },
                    SkillBuff { skillName: 'Forest Senses', index: 0, buff: buff::new(BuffType::AttackUp, 60, 3, false, false, true) },
                    SkillBuff { skillName: 'Forest Senses', index: 1, buff: buff::new(BuffType::SpeedUp, 60, 3, false, false, true) },
                    SkillBuff { skillName: 'Sand Strike', index: 0, buff: buff::new(BuffType::AttackUp, 50, 2, false, false, true) },
                    SkillBuff { skillName: 'Sandstorm', index: 0, buff: buff::new(BuffType::SpeedDown, 15, 3, false, true, false) },
                    SkillBuff { skillName: 'Nature Call', index: 0, buff: buff::new(BuffType::SpeedUp, 35, 2, false, true, false) },
                    SkillBuff { skillName: 'Holy Bastion', index: 0, buff: buff::new(BuffType::DefenseUp, 45, 3, false, true, false) },
                    SkillBuff { skillName: 'Divine Hammer', index: 0, buff: buff::new(BuffType::SpeedDown, 40, 2, true, false, false) },
                    SkillBuff { skillName: 'Divine Hammer', index: 1, buff: buff::new(BuffType::AttackDown, 40, 2, true, false, false) },
                    SkillBuff { skillName: 'Tide Strike', index: 0, buff: buff::new(BuffType::AttackUp, 50, 2, false, true, false) },
                    SkillBuff { skillName: 'Chum Challenge', index: 0, buff: buff::new(BuffType::DefenseUp, 60, 3, false, false, true) },
                    SkillBuff { skillName: 'Chum Challenge', index: 0, buff: buff::new(BuffType::AttackUp, 60, 3, false, false, true) },
                    SkillBuff { skillName: 'Snow Storm', index: 0, buff: buff::new(BuffType::AttackDown, 30, 2, false, true, false) },   
                    SkillBuff { skillName: 'Lignum Hammer', index: 0, buff: buff::new(BuffType::Stun, 0, 1, true, false, false) },
                    SkillBuff { skillName: 'Buloke Wall', index: 0, buff: buff::new(BuffType::DefenseUp, 45, 2, false, true, false) },
                    SkillBuff { skillName: 'Silvan Chant', index: 0, buff: buff::new(BuffType::Regen, 4, 2, false, true, false) },
                    SkillBuff { skillName: 'Astral Beam', index: 0, buff: buff::new(BuffType::AttackDown, 50, 2, true, false, false) },
                    SkillBuff { skillName: 'Raging Fire', index: 0, buff: buff::new(BuffType::DefenseDown, 40, 2, true, false, false) },
                    SkillBuff { skillName: 'Ember Infusion', index: 0, buff: buff::new(BuffType::SpeedUp, 30, 2, false, true, false) },
                    SkillBuff { skillName: 'Ember Infusion', index: 1, buff: buff::new(BuffType::AttackUp, 30, 2, false, true, false) },
                    SkillBuff { skillName: 'Blazing Rage', index: 0, buff: buff::new(BuffType::DefenseUp, 60, 3, true, false, false) },
                    SkillBuff { skillName: 'Blazing Rage', index: 1, buff: buff::new(BuffType::AttackUp, 60, 3, true, false, false) },
                    SkillBuff { skillName: 'Wisp Infusion', index: 0, buff: buff::new(BuffType::SpeedUp, 40, 2, false, true, false) },
                    SkillBuff { skillName: 'Swords Dance', index: 0, buff: buff::new(BuffType::AttackUp, 60, 2, false, true, false) },
                    SkillBuff { skillName: 'Celestial Judgement', index: 0, buff: buff::new(BuffType::DefenseDown, 40, 2, true, false, false) },
                    SkillBuff { skillName: 'Ankh Blessing', index: 0, buff: buff::new(BuffType::DefenseUp, 35, 3, false, true, false) },
                    SkillBuff { skillName: 'Khonsu Blessing', index: 0, buff: buff::new(BuffType::Regen, 10, 2, true, false, false) },
                    ...
                    SkillBuff { skillName: 'Sand Flurry', index: 0, buff: buff::new(BuffType::DefenseDown, 40, 2, true, false, false) },
